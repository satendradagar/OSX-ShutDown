...
#define PARAMETER_FORMAT_JSON @"{\"id\":\"%@\",\"email_address\":\"%@\",\"apikey\":\"%@\",\"merge_vars\":{\"FNAME\":\"%@\",\"LNAME\":\"%@\",\"Serial\":\"%@\"}}"
...
- (NSMutableData *)encodeRequestParams:(NSDictionary *)params {
    ...
    NSString *outRes =  [NSString stringWithFormat:PARAMETER_FORMAT_JSON,(NSString *)[postBodyParams valueForKey:@"id"], (NSString *)[postBodyParams valueForKey:@"email_address"], (NSString *)[postBodyParams valueForKey:@"apikey"], (NSString *)[mergeVars valueForKey:@"FNAME"], (NSString *)[mergeVars valueForKey:@"LNAME"], (NSString *)[mergeVars valueForKey:@"Serial"]];
    NSLog(@"outRes = %@",outRes);
